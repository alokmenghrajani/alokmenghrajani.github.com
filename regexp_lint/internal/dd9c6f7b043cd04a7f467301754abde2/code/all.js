...
var _bF = {};
var _bG = {};
(function (){function a(){}var b =new Array();var c =new Array();function d(){return Math.floor(Math.random() * 1073741824);}var e =-1;if (typeof page_server != "undefined") {e = page_server;} else {_V || _Bl("Warning: the server hasn't set the page number");e = d();}var f ="";f = typeof base_url != "undefined"?base_url:"";var g =f + "/internal/" + e,h =true,i =typeof desactivate_safari_hack == "undefined" || !desactivate_safari_hack;if (i && !_V && "userAgent" in navigator) {var j =navigator.userAgent;h = !/Safari/.test(j) || /Chromium/.test(j);}var k =function (Q){_X("Unregistered serialization function");},l =function (Q){_X("Unregistered unserialization function");},m =3;function n(){var Q =d(),R =_Db();if ("none" in R) {
...
var _nb = {client:"internal",page:-1};
